...
# todo: rewrite into API requests and stuff:
...
# curl -sLk -XPOST https://b.lan:5001/api/v0/files/read?arg=/a/root/data/chain/latest
# curl -sLk -XPOST https://b.lan:5001/api/v0/files/stat?arg=/a/root/data/chain/latest | jq .Hash | sed "s/\"//g"
# curl -sLk -XPOST https://b.lan:5001/api/v0/files/rm?arg=/path/to/file/to/remove
# curl -sLk -XPOST "https://b.lan:5001/api/v0/files/cp?arg=/ipfs/cid&arg=/path/to/cid"
# echo tmp | curl -sLk -XPOST -F file=@- "https://b.lan:5001/api/v0/files/write?arg=/created/cid/test&create=true&cid-version=1"
